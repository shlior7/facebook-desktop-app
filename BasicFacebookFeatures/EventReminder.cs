...
namespace BasicFacebookFeatures
{
...

    {
        ...
        public string EventName { get { return m_Event.Name; } }

        public string EventLocation { get { return m_Event.Location; } }

        public string EventStartTime { get { return m_Event.StartTime.ToString() ?? "No start time"; } }

        public string TimeBeforeToRemind { get { return $"{((DateTime)m_Event.StartTime).Subtract(TimeToAlert).ToString()} Before"; } }
